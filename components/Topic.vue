    ...
    <div>
        <div class="border-b-[1px] border-b-[#EDF1F1]" :class="[isExpanded ? 'border-b-transparent' : isHovered ? 'border-b-transparent' : 'border-current']">
            ...
            class="flex justify-between items-center mt-6 py-4 text-[#00212F] transition duration-500">
                <div class="flex justify-start items-center ml-5 space-x-10 font-medium">
                    <div :class="[isHovered ? 'text-[#39E8EA]' : isExpanded ? 'text-[#39E8EA]' : 'text-[#002738]']" 
                    class="py-2 px-3 rounded-full bg-[#FFFFFF] transition duration-500">01</div>
            ...
            <div v-else>
                <svg @click="expand()" class="mr-5 w-10 h-10" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
