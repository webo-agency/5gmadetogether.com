                        ...
                        <div class="swiper-wrapper flex h-full">
                                <div class="swiper-slide w-1/6 max-w-[280px]">
                                    ...
                                    <div @mouseover="isHovered = true" @mouseleave="isHovered = false" class="relative overflow-hidden w-auto h-auto">
                                        ...
                                        height="350px"
                                        />
                                        <div @mouseover="isHovered = true" @mouseleave="isHovered = false" class="absolute flex bottom-2 left-2 z-40">
                                            ...
                                            <div class="ml-6 text-[#FFFFFF] text-xl uppercase">Mark Sadowsky</div>
                                        </div>
                                    </div>
