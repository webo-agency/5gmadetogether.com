<template>
  ...
  >
    <div class="container relative w-full mx-auto z-50">
      <h2
        class="text-white text-5xl leading-tight font-semibold font-heading mb-4"
      >
    ...
    <div
      class="absolute desktop:rounded-t w-full h-full inset-0 z-0 bg-blue-200 overlay"
    >
      <picture>
        <source :srcSet="generalData.cta_background.url" type="image/jpeg" />
        <img
